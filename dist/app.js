        ...
        render() {
            ...
            <div class="menu">
                <a class="menu__item" href="#">
                    <img src="/static/images/search.svg" alt="Поиск иконка"/>
                    Поиск книг
                </a>
    ...
    class Search extends DivComponent {
        ...
        render() {
           ...
           <div class="search__wrapper">
            ...
            />
            <img src="static/images/search.svg" alt="Иконка поиска" />
           </div>
           <button aria-label="искать">
                <img src="/static/images/search_btn.svg" alt="Иконка кнопки поиска" />
           </button>
        `;
